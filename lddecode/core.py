...
class LDdecode:
    def __init__(
        ...
        if fname_out is not None and self.ac3:
            if _ac3rf is None:
                raise RuntimeError("ac3rf Python module not found; install museld with BUILD_PYTHON=ON")
            block_size = 32768
    ...
    def AC3demodulate(self, f):
        ...
        new_start = max(0, self.ac3_processed_bytes - block_start) // raw.itemsize
        self.ac3_processed_bytes = block_start + raw.nbytes
